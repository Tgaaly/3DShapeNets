function model = run_pretrain_semantic5()
...
param.network = {
    ...
    struct('type', 'convolution', 'outputMaps', 160, 'kernelSize', 5, 'actFun', 'sigmoid', 'stride', 1);
    struct('type', 'convolution', 'outputMaps', 256, 'kernelSize', 4, 'actFun', 'sigmoid', 'stride', 1);
    struct('type', 'fullconnected', 'size', 1024, 'actFun', 'sigmoid');
    struct('type', 'fullconnected', 'size', 2048, 'actFun', 'sigmoid');
};
...
save('pretrained_model_semantic5.mat','model');
