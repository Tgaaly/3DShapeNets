...
param.network = {
    ...
    struct('type', 'convolution', 'outputMaps', 128, 'kernelSize', 5, 'actFun', 'sigmoid', 'stride', 1);
    struct('type', 'convolution', 'outputMaps', 320, 'kernelSize', 5, 'actFun', 'sigmoid', 'stride', 1);
    struct('type', 'fullconnected', 'size', 1200, 'actFun', 'sigmoid');%64, 'actFun', 'sigmoid');
    struct('type', 'fullconnected', 'size', 3008, 'actFun', 'sigmoid');%80, 'actFun', 'sigmoid');
};
% param.network = {
%     struct('type', 'input');
